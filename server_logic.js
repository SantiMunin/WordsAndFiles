module.exports = function(io) {
  ...
  exports.login = function(nickname, callback) {
  ...
  exports.log_user_out = function(nickname) {
    console.log("Logging "+nickname+" out");
    people[nickname] = undefined;
  };

  exports.request_chat = function(source, target, callback) {
  ...
  exports.leave_chat = function(nickname) {
